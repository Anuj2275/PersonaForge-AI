...
export default function PersonaCard({ persona, onArchive, onUnarchive }) {
  ...
  return (
    <article
      className={`card p-5 cursor-pointer relative overflow-hidden ${persona.archived ? 'opacity-55 hover:opacity-75' : 'hover:-translate-y-0.5'}`}
      role="listitem"
      tabIndex={0}
    ...
    >
      ...
      <div className={`flex items-start justify-between mb-3.5 ${persona.archived ? 'pt-4' : ''}`}>
        <div
